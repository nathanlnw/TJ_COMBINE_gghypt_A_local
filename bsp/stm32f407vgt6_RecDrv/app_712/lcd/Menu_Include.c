...
unsigned char device_version[30]={"主机版本:AnKai.BUS"};  //{"主机版本:V BD 2.00"};   // 北斗货运平台对接  
unsigned char bd_version[20]={"模块版本:V 17.AK.001"};
unsigned char bd_version2[20]={"模块版本:V 20.AK.001"};   
